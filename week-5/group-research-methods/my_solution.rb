...
#
# Ruby docs are pretty sweet. I'm used to doing challenges that force you to tackle problems creatively without built in methods, but this makes me want to collect a full tool belt and show Ruby who's boss. I definitely feel like I'll have a better handle on the methods I researched than the ones I learn from my group, only because struggling and failing with other methods cemented my understanding of the limitations and abilities of each method.
#
#