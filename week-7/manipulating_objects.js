...
// The only time I got an error was on #8 - I tried to assign name = "Carson", but then fixed it to name: "Carson"
// Also had to look up the delete function.

// How difficult was it to add and delete properties outside of the object itself?

// Pretty easy. I can't think of a way JS' creators could have made it easier actually.

// What did you learn about manipulating objects in this challenge?
//
// It works kind of like Ruby hashes, but reads more clearly than listing like hash[key] = value
// Pretty accessibly interchangable values - I liked that last touch assigning all Terah's children to Adam with one assignment.
//
