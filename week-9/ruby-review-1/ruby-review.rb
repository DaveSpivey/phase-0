...
# Mostly renamed variables etc in this refactor, but totally didn't keep the first version from coderpad, so just have the final version above.
...
# Ruby objects - having a sort of reverse-culture-shock moment where I keep wanting to do JavaScript things now.

# What is still confusing to you about Ruby?

# After getting back into the swing, I remembered that I definitely like objects in Ruby better than JS
