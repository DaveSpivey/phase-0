...
my_info = {:first_name => "Dave", :last_name => "Spivey", :hometown => "Davis", :age => 33}

p "My name is #{my_info[:first_name]} #{my_info[:last_name]}, I live in #{my_info[:hometown]} and I'm #{my_info[:age]}."
